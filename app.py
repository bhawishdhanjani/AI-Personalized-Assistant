...
from langchain_community.document_loaders import Docx2txtLoader, UnstructuredExcelLoader, CSVLoader, TextLoader, PyPDFLoader, UnstructuredPowerPointLoader
# from langchain_pinecone import PineconeVectorStore
# from langchain_chroma import Chroma, Fai
...
class RAGAssistant:
    ...
    def process_documents(self, documents):
        ...
        embeddings = OpenAIEmbeddings()
        # Pinecone(api_key=self.pinecone_api_key, environment='gcp-starter')
        vectbd = vectbd = PineconeVectorStore.from_documents(
            documents=docs,
            embedding=embeddings,
            index_name="bhawesh",
            namespace="wondervector5000"
...
st.title("AI Personalized Assistant")
...
if option == "Chat":
    ...
    uploaded_file = st.file_uploader(
        "Upload a file for fine-tuning", type=["txt", "pdf", "csv", "xlsx", "docx", "pptx"])
